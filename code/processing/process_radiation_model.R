...
# Processing department-level radiation model 
#=============================================================================#
...
load('../data/processed_epi_data.RData')
...
# load shapefile
admin_2 <- readShapePoly('../output/radiation_model/col_admbnda_adm2_unodc_ocha/col_admbnda_adm2_unodc_ocha.shp')
...
save(connectivity_radiation_normalized, file = '../output/radiation_model/processed_radiation_model.RData')
