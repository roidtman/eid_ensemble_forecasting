...
load('~/Dropbox/forecasting_tsir/data/processed/processed_epi_data.RData')
...
# admin_1 <- readShapePoly('~/Dropbox/forecasting_tsir/data/colombia_dptos/Colombia_merged_dptos.shp')
admin_1 <- readShapePoly('~/Desktop/col_admbnda_adm1_unodc_ocha/col_admbnda_adm1_unodc_ocha.shp')
...
save(connectivity_gravity_normalized, file = '~/Dropbox/forecasting_tsir/data/processed/processed_gravity_model.RData')
